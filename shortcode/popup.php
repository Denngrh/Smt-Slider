    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            function showSlides(n) {
                ...
                slides.eq(slideIndex - slides.length).css("display", "relative");
                text.eq(slideIndex - slides.length).css("display", "relative");
                link.eq(slideIndex - slides.length).css("display", "relative");
