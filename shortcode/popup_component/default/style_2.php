            ...
            <div class="popup-content">
                <div class="popup-text-container">
                    <div class="div_text">
                        ...
                        <div class="text">
                            <div class="text-wrapper-1">
                            <<?php echo $css_data['title_size']; ?>> Lorem ipsum dolor sit, amet consectetur</<?php echo $css_data['title_size']; ?>>
                            </div>
                            <div class="text-wrapper-2">
                        ...
                        <div class="link" data-id="1" data-image="https://img.freepik.com/free-photo/man-with-hands-wide-open-standing-top-mountain-enjoying-incredible-view-lake_181624-50789.jpg?w=740&t=st=1695884981~exp=1695885581~hmac=d249d3befb6c5de2f94a1ab1015ba38bf67e03f716558334b9e17c0a6327ee4a">
                            <a href="https://example.com" target="_blank" rel="noopener noreferrer">
                                <div type="button" class="tombol">Click ME!</div>
                            </a>
                        </div>
                    </div>
                </div>
